...
public class L11_Q2 extends Application{
    public void start(Stage primaryStage) {
        ...
        showTableButton.setOnAction(e -> {
            ...
            try {
                ...
                resLabel.setText(table.toString());
            } catch (NumberFormatException ex) {
                resLabel.setText("Please enter a valid integer.");
            }
        });

        // Add controls to the FlowPane
        flowPane.getChildren().addAll(promptLabel, numberField, showTableButton, resLabel);
